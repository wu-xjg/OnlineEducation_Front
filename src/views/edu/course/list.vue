     ...
     >
      ...
      <el-table-column label="课程封面" >
          <template slot-scope="scope">
						...
						<el-popover placement="top-start" trigger="hover" :ref="`popover-${scope.$index}`" width="180px">
            <a :href="scope.row.cover" target="_blank" title="查看最大化图片"><img :src="scope.row.cover" style="width: 120px;height: 120px" /></a>

            <img slot="reference" :src="scope.row.cover" style ="width: 70px;height: 70px; cursor:pointer"  alt="https://wg-file.oss-cn-shanghai.aliyuncs.com/course/F5BA44A62421FF85E73924EFDA1041D2.jpg"/>
